    ...
    function html5Upload() {	
    	...
    	sUploadURL= '/js/smarteditor2/sample/photo_uploader/multiImageUploader.jsp'; 	//upload URL
	...
	function onAjaxError (){
 	...
 	function callFileUploader (){
 		oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
 			sUrl  : '/fileupload/single',	//샘플 URL입니다.
 	        sCallback : '/js/smarteditor2/sample/photo_uploader/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
...
// 	    		oCustomEvent.stop(); 수행시 bAllowed 가 false이더라도 alert이 수행되지 않음
	...
	window.onload = function(){ //hoonEdit
  		// checkDragAndDropAPI();
  		//
  		// if(bSupportDragAndDropAPI){
