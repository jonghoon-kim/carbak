		...
		$.fn.FadeWideBgImg = function (options){
			...
			function slideshowstart(){
					...
					SlideIntval = setInterval(function(){
						//console.log("로드완료 후 인터벌" + SlideIntval + "몇일까요 : ");						
						if(ShowCurrent > 0){
						...
						//END if									
					}, setValue.interval = 10000, setValue.height=835);
					console.log('결과 ShowCurrent : '+ setValue.height);
					console.log('결과 ShowCurrent : '+ setValue.interval);
					// end - setinterval				
			}
