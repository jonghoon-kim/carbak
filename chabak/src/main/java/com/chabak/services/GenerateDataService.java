...
//                createdString = today+"-"+i;
    ...
    public int generateReviewData(int numberOfGenerate){
        ...
        for(int i=0;i<numberOfGenerate;i++){
            ...
            SidoAndGugun sidoAndGugun = this.randomSidoGugun();
            review.setSido(sidoAndGugun.getSido());
            review.setGugun(sidoAndGugun.getGugun());
...
////                review.setTitleImageSrc("/resources/img/campsite/noImage1.png");
    ...
    @SneakyThrows
    public SidoAndGugun randomSidoGugun(){
        ...
        int randomSidoIndex = (int)(Math.random() * sidoSize);
        int gugunLength = gugun[randomSidoIndex].length;
        int randomGugunIndex = (int)(Math.random() * gugunLength);
        SidoAndGugun sidoAndGugun = new SidoAndGugun();
        sidoAndGugun.setSido(sido[randomSidoIndex]);
        sidoAndGugun.setGugun(gugun[randomSidoIndex][randomGugunIndex]);
